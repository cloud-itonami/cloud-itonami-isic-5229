# Operator Quickstart — Community Freight Forwarding and Customs Brokerage

Shortest path from clone to a verified local dry-run for **ISIC 5229** (`cloud-itonami-isic-5229`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5229.git
cd cloud-itonami-isic-5229
```
...
- Blueprint governor key: `freight-forwarding-governor`
- Likely source path: `src/**/freight-forwarding-governor.cljc`
